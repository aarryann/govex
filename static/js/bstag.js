...
(function(global, factory) {
  ...
  var css =
    ".not-selectable{-webkit-touch-callout:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.tag{padding:5px 10px;background-color:#007bff;color:#fff;display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;border-radius:5000px;border:1px transparent;margin-bottom:5px;margin-right:5px}.tag p,.tag span{margin:0;padding:0}.tag span.active{padding-left:5px;margin-left:5px;border-left:1px solid #fff}.suggestion{z-index:1}.suggestion.list-group-item.active{background-color:#333;border-color:#333}.suggestion.list-group-item.active .tag{border:1px solid;border-color:inherit}.tag button{color:#000;opacity:.75;text-decoration:none;padding:0;padding-left:5px;border-style:none;border:0;font-size:24px;font-size:1.5rem;font-weight:800;line-height:1;text-transform:none;overflow:visible;margin:none;-webkit-box-sizing:border-box;box-sizing:border-box;background-color:transparent;vertical-align:middle}.tag button:hover{color:#fff;opacity:1}.dsm-mt-pseudo-input-element{margin-bottom:5px}.dsm-mt-pseudo-input-element:focus{border:2px solid #0097cf}.dsm-mt-tag-area{padding-left:16px;padding-left:1rem;max-height:200px;overflow-y:auto;margin-bottom:0}.dsm-mt-tag-area.disabled{background-color:#9fa4aa}.dsm-mt-typeahead-input-area{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;width:2px;padding:0;overflow:auto;background-color:transparent;border:none;outline:none;-webkit-box-shadow:none;box-shadow:none}.dsm-mt-form-element{border:2px dashed #ccc;padding:1em;margin:1em 0}.dsm-mt-typeahead-suggestion-area{position:absolute;max-height:400px;overflow-y:auto}.soft-border{background-color:#fff;border:1px solid #ccc;border-radius:8px;padding-top:0px}.hidden-form{display:none}.dsm-mt-inline-form{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;width:100%;--bc:#333;--bsw:1px;--bgc:#fff}.dsm-mt-inline-form input{margin-top:0;padding:0}.dsm-mt-inline-form .dsm-mt-pseudo-input-element{width:100%;background-color:var(--bgc);margin-bottom:0;border-radius:10px 0 0 10px;border:var(--bsw) solid var(--bc)}.dsm-mt-inline-form .dsm-mt-btn-submit{display:inline-block!important;cursor:pointer!important;padding:0 10px!important;color:#fff!important;background-color:#007bff!important;text-align:center!important;vertical-align:middle!important;border-radius:0 10px 10px 0!important;border:var(--bsw) solid!important;border-color:var(--bc)!important;border-left:0!important;background-color:rgba(0,123,255,.96078)!important;-webkit-transition:all .3 ease;transition:all .3 ease}.dsm-mt-inline-form .dsm-mt-btn-submit:hover{opacity:.75!important;-webkit-transition:all .5 ease!important;transition:all .5 ease!important}.dsm-mt-inline-form .dsm-mt-tag-area{height:auto;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:wrap;flex-wrap:wrap;width:100%!important}.dsm-mt-inline-form .tag,.dsm-mt-inline-form input{margin-top:5px;display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;white-space:nowrap}";
  styleInject(css);
