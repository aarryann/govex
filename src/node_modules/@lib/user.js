...
const client = new ApolloClient({
  link: createHttpLink({
    uri: `${process.env.PROTOCOL}://${process.env.HOST}:${process.env.PORT}/${process.env.GRAPHQL_EXT}`,
    fetch: fetch,
  }),
...
export async function findUser({ username, password }) {
  ...
  // console.log(`${process.env.PROTOCOL}://${process.env.HOST}:${process.env.PORT}/${process.env.GRAPHQL_EXT}`);
  const payload = {
